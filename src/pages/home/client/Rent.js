                                    ...
                                    <div className="row">
                                        {currentUser ? (
                                            user.gender === room.type ? (
                                                <div className="col-lg-12 pb-2 d-flex justify-content-between">
                                                    <div className="col-lg-6">
                                                        <Link className="btn btn-outline-danger w-100" to={"/"}>Không thuê</Link>
                                                    </div>
                                                    <div className="col-lg-6">
                                                        <button className="btn btn-outline-success w-100" onClick={handleRent}>Thuê</button>
                                                    </div>
                                                </div>
                                            ) : (
                                                <div className="col-lg-12">
                                                    <Link className="btn btn-outline-danger w-100" to={"/"}>Không thể thuê phòng dành cho {room.type}</Link>
                                                </div>
                                            )
                                        ) : (
                                            <div className="col-lg-12">
                                                <Link className="btn btn-outline-danger w-100" to={"/request"}>Không thể thuê phòng, vui lòng đăng nhập hoặc đăng ký để thuê</Link>
                                            </div>
                                        )}
                                    </div>
                                </div>
